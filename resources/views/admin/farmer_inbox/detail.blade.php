...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-sm-4">
		...
		<ol class="breadcrumb">
            ...
            <li>
                <a href="{{ url('admin/inbox/customer') }}">ข้อความฟาร์มเมอร์</a>
            </li>
			<li class="active">
        ...
        <div class="ibox-content mailbox-content">
            <div class="file-manager">
                ...
                <ul class="folder-list m-b-md" style="padding: 0">
                    <li><a href="{{ url('admin/inbox/farmer') }}"> <i class="fa fa-inbox "></i> กล่องข้อความ <span class="label label-primary pull-right">{{ App\CustomerInbox::count() }}</span> </a></li>
                </ul>
                <h5>ประเภทข้อความ</h5>

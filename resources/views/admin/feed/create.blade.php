	...
	<div class="col-sm-4">
      ...
      <li>
        <a href="{{ url('admin/feed') }}">ข้อมูลข่าวสาร</a>
			...
			<li class="active">
				<strong>เพิ่มข้อมูลข่าวสาร</strong>
			</li>
		</ol>
	</div>
</div>
        ...
        <div class="wrapper wrapper-content animated fadeInUp">
	         ...
	         <div class="ibox">
                <div class="ibox-title">
                	...
                	<form action="{{ route('admin.feed.store') }}" method="POST" class="form-horizontal">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="form-group {{ $errors->has('topic') ? 'has-error' : '' }}">
                        	<label class="col-lg-2 control-label"> ชื่อหัวข้อ</label>
                            <div class="col-lg-10">
                            	<input type="text" placeholder="กรอกชื่อหัวข้อข่าวสาร" name="topic" class="form-control" value="{{ old('topic') }}">
                                @if($errors->has('topic'))
                                ...
                                @endif
												...
												<div class="form-group {{ $errors->has('detail') ? 'has-error' : '' }}">
													<label class="col-lg-2 control-label"> รายละเอียด</label>
														<div class="col-lg-10">
															<textarea name="detail" id="textarea" rows="8" cols="40" class="form-control" ></textarea>

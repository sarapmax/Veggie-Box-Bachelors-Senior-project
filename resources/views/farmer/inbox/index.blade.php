        ...
        <div class="ibox-content mailbox-content">
            <div class="file-manager">
                ...
                <ul class="folder-list m-b-md" style="padding: 0">
                    <li><a href="{{ url('farmer/inbox') }}"> <i class="fa fa-inbox "></i> กล่องข้อความ <span class="label label-primary pull-right">{{ App\FarmerInbox::where('farmer_id', auth()->guard('farmer')->user()->id)->count() }}</span> </a></li>
                </ul>
                <h5>ประเภทข้อความ</h5>
...
<div class="mail-box-header">
    <h2>
        ข้อความทั้งหมด ({{ App\FarmerInbox::where('farmer_id', auth()->guard('farmer')->user()->id)->count() }})
    </h2>
    ...
    <tr class="read">
        ...
        <td class="mail-ontact"><a href="{{ url('farmer/inbox/detail/'.$inbox->slug) }}">
                {{ $inbox->farmer->farm_name }}
            </a></td>
        <td class="mail-subject"><a href="{{ url('farmer/inbox/detail/'.$inbox->slug) }}">{{ $inbox->topic }}</a></td>

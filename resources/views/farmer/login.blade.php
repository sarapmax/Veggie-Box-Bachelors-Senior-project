    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="ibox-content"> 
                ...
                <form class="m-t" role="form" action="{{ url('farmer/login') }}" method="POST">
                    ...
                    <a class="btn btn-sm btn-white btn-block" href="{{ url('farmer/register') }}"><i class="fa fa-edit"> </i> สมัครสมาชิก</a>
                </form>
               <br/>
            </div>
        </div>
